...
def test_model(path_to_model='best_model', path_to_test='test-A/in.tsv', path_to_out='test-A/out.tsv'):
    ...
    with open(path_to_test) as f, open(path_to_out, 'w') as out:
        ...
        for idx, text in splitted:
            preds = __ids_to_labels(model.predict([text.split()], context='store_true')[0], pred_labels)
